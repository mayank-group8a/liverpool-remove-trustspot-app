    ...
    var i = n(3),
        a = (n(6), function () {
            ...
            return _createClass(e, [{
                ...
                key: "_attachListeners",
                value: function () {
                    this._openListener = this.open.bind(this), this._closeListener = this.close.bind(this), this._calculateMaxHeightListener = this._calculateMaxHeight.bind(this), this.delegateBody.on("click", '[data-action="open-drawer"][data-drawer-id="' + this.element.id + '"]', this._openListener), this.delegateBody.on("click", '[data-action="close-drawer"][data-drawer-id="' + this.element.id + '"]', this._closeListener), 
    ...
    var i = n(9),
        ...
        l = function () {
            function e(t, n) {
                ...
                // Modi Change start
                // console.log('variant1: ',a);
                // console.log('variant2: ',window.current);
                $(document).on("change", '.bundle_propertys .HorizontalList--spacingTight .bundleSwatch__Radio', function(event) { 
                    a = window.current;
                    //$('.ProductForm__Option .HorizontalList--spacingTight .HorizontalList__Item input').prop('checked', false);
                    // console.log('variant1: ',a);
                    // console.log('variant2: ',window.current);
                });
                // Modi Change End
            ...
            return _createClass(e, [{
                ...
                value: function (e) {
                    ...
                    i.setAttribute("type", "submit"), i.className = "ProductForm__AddToCart Button Button--full", e ? e.available ? (i.removeAttribute("disabled"), i.classList.add(this.options.showPaymentButton ? "Button--secondary" : "Button--primary"), i.setAttribute("data-action", "add-to-cart"), this.productData.tags.includes('TryNow') ? i.addEventListener('click', handleOriginalBtn) : null, this.productData.tags.includes('Final Sale') ? i.addEventListener('click', handleFinalSaleButtonClick) : null, void 0 === this.options.showPriceInButton || this.options.showPriceInButton ? i.innerHTML = "\n            <span>" + window.languages.productFormAddToCart + '</span>\n            <span class="Button__SeparatorDot"></span>\n            <span data-money-convertible>' + r["default"].formatMoney(e.price, window.theme.moneyFormat) + "</span>\n          " : i.innerHTML = "<span>" + window.languages.productFormAddToCart + "</span>")  : (i.setAttribute("disabled", "disabled"), i.classList.add("Button--secondary"), i.removeAttribute("data-action"), i.innerHTML = window.languages.productFormSoldOut) : (i.setAttribute("disabled", "disabled"), i.removeAttribute("data-action"), i.classList.add("Button--secondary"), i.innerHTML = window.languages.productFormUnavailable), this.options.showPaymentButton && n && (e && e.available ? n.style.display = "block" : n.style.display = "none"), t.parentNode.replaceChild(i, t)
                }
            }, {
                key: "_onOptionChanged",
                value: function (e, t, n) {

                    // MKT fix buy it now button issue
                    setTimeout(function () {
                        var buttonaction = $(".Button--secondary").is(":disabled");
                        console.log('New buttonaction--' + buttonaction);
                        ...
                        if(buttonaction === true){
                          $("button.btn.swym-button.swym-add-to-watchlist").show();
                          $(".customBISModalWrap #emailMeWhenAvailableBtn").show();
                        }else{
                          $(".customBISModalWrap #emailMeWhenAvailableBtn").hide();
                          $("button.btn.swym-button.swym-add-to-watchlist").hide();
                        }
                    }, 500);
                    //$("#update_url").attr("href","https://liverpooljeans.com/cart/"+this.currentVariant.id+":1");
                    // MKT fix buy it now button issue
                    ...
                    this.currentVariant = this._getCurrentVariantFromOptions(), this._onVariantChanged(a, this.currentVariant)
                    // Modi Change start
                    , console.log('currentVariant: ',this.currentVariant)
                    , window.currentVariant=this.currentVariant
                    // console.log('masterSelector: ',this.masterSelector);
                    // console.log(document.querySelector('.ProductForm__Option [value="' + this.currentVariant.id + '"]'));
                    , this.currentVariant && (
                        console.log(this.currentVariant.id),
                        $('#update_url').attr('onclick',`shoprunner_buy_it_now('https://${Shopify.shop}/cart/${this.currentVariant.id}:1');`),
                        // console.log(),
                        document.querySelector(".ProductForm__Option select").value = this.currentVariant.id
                    )
                ...
                value: function () {
                    var e = this,
                        t = !1;
                    //console.log(e.option1,e.option2,e.option3);

                    document.dispatchEvent(new CustomEvent('variantChanged', { detail: current }));
                    
                    return window.current.variants.forEach(function (n) {
                ...
                value: function (e) {
                    ...
                    console.log('_updateHistoryState' + e.id);

                    $("#update_url").attr("href", "https://liverpooljeans.com/cart/" + e.id + ":1");

                    if (history.replaceState) {
                        var t = window.location.protocol + "//" + window.location.host + window.location.pathname + "?variant=" + e.id;
                        $("#test_selected_varid").val(e.id);
                ...
                key: "_addToCart",
                value: function (e) {
                    // if (document.querySelectorAll('.SizeSwatchList').length === 1) {
                    if (document.querySelectorAll('.SizeSwatchList').length === 1 && document.querySelectorAll('.ProductForm__Variants .ProductForm__Option.ProductForm__Option--labelled  input[type="radio"]:checked').length === 0) {
                        e.preventDefault();
                        // alert('Please select a product size')
                        $('.ProductForm__AddToCart').after('<span class="ProductForm__Error Alert Alert--error">Please select a product size</span>');
                        setTimeout(function () {
                            $('.ProductForm__AddToCart').siblings('.ProductForm__Error').remove();
                        }, 2500);
                    } else {
                        var t = this;
                        if (this.options.useAjaxCart) {
                            ...
                            fetch("/cart/add.js", {
                              ...
                              /* addToCart Event success */
                              // MODI 21-04-2021 added
                              console.log("Add to cart event call!",product);
                              fbq('track', 'AddToCart');
                              gtag_report_conversion('',product);
                              triggered();
                              // MODI 11-05-2021 added
                              /* End of addToCart Event success */  
                            }), e.preventDefault()
                        ...
                        t.json().then(function (n) {
                            ...
                            if (t.ok) {
                                ...
                                Object.keys(n).forEach(function (e) {
                                    c += '<li class="Alert__ErrorItem" role="alert">' + e + " " + n[e] + "</li>"
        ...
        r = function () {
            ...
            return _createClass(e, [{
                ...
                value: function (e, t) {
                    ...
                    // MKT 16-04 added function
                    setTimeout(function () {
                        console.log("call window.sr_updateMessages();");
                ...
                value: function (e) {
                    ...
                    return n.forEach(function (e) {
                        ...
                        e = t.itemCount
                        $('.sr-only.Header__CartCount').text(`Cart (${e}) ${e < 2 ? 'item' : 'items'}`);
                ...
                value: function (e) {
                    ...
                    if (this.options.drawer) {
                        ...
                        n.replaceChild(t.querySelector(".Cart"), this.element.querySelector(".Cart")), this.element.querySelector(".Drawer__Main").scrollTop = i, document.dispatchEvent(new CustomEvent("quantityChanged"))
    ...
    var i = n(0),
        ...
        o = function () {
            ...
            return _createClass(e, [{
                ...
                key: "_attachListeners",
                value: function () {
                    this._checkTransparentHeaderListener = this._checkTransparentHeader.bind(this), this._closeNavigationListener = this._closeNavigation.bind(this), this._focusNavigationListener = this._focusNavigation.bind(this), this._verifyNavigationOverlapListener = this._verifyNavigationOverlap.bind(this), this.element.addEventListener("mouseleave", this._closeNavigationListener), this.delegateElement.on("mouseenter", "[aria-haspopup]", this._openMenu.bind(this), !0), this.delegateElement.on("focusin", "[aria-haspopup]", this._openMenu.bind(this), !0), this.delegateElement.on("focusout", "[aria-haspopup]", this._closeMenu.bind(this), !1), this.delegateElement.on("mouseleave", ".DropdownMenu [aria-haspopup]", this._closeMenu.bind(this), !0), this.delegateElement.on("mouseenter", ".DropdownMenu [aria-haspopup]", this._adjustDropdownPosition.bind(this), !0), this.isTouch && this.delegateElement.on("click", ".Header__MainNav [aria-haspopup]", this._handleTouchMenu.bind(this)), this.options.hasTransparentHeader && (this.element.addEventListener("mouseenter", this._focusNavigationListener), this.element.addEventListener("focusin", this._focusNavigationListener)), this.options.isSticky && this.options.hasTransparentHeader && window.addEventListener("scroll", this._checkTransparentHeaderListener), "inline" === this.options.navigationStyle && window.addEventListener("resize", this._verifyNavigationOverlapListener)
                    this._checkTransparentHeaderListener = this._checkTransparentHeader.bind(this), this._closeNavigationListener = this._closeNavigation.bind(this), this._focusNavigationListener = this._focusNavigation.bind(this), this._verifyNavigationOverlapListener = this._verifyNavigationOverlap.bind(this), this.element.addEventListener("mouseleave", this._closeNavigationListener), this.delegateElement.on("click", "[aria-haspopup]", this._openMenu.bind(this), !0), this.delegateElement.on("focusin", "[aria-haspopup]", this._openMenu.bind(this), !0), this.delegateElement.on("focusout", "[aria-haspopup]", this._closeMenu.bind(this), !1), this.delegateElement.on("mouseleave", ".DropdownMenu [aria-haspopup]", this._closeMenu.bind(this), !0), this.delegateElement.on("mouseenter", ".DropdownMenu [aria-haspopup]", this._adjustDropdownPosition.bind(this), !0), this.isTouch && this.delegateElement.on("click", ".Header__MainNav [aria-haspopup]", this._handleTouchMenu.bind(this)), this.options.hasTransparentHeader && (this.element.addEventListener("mouseenter", this._focusNavigationListener), this.element.addEventListener("focusin", this._focusNavigationListener)), this.options.isSticky && this.options.hasTransparentHeader && window.addEventListener("scroll", this._checkTransparentHeaderListener), "inline" === this.options.navigationStyle && window.addEventListener("resize", this._verifyNavigationOverlapListener)
                ...
                value: function (e) {
                    ...
                    if (t && t.featured_image && (!n || !n.featured_image || n.featured_image.id !== t.featured_image.id))
                        if (u.ResponsiveHelper.matchesBreakpoint("pocket") || !this.options.stackProductImages)
                            ...
                            } else $('[href="#Image' + t.featured_image.id + '"]').trigger('click')
                            // } else console.log('featured_image',t.featured_image.id)
                }
            }, {
...
$('li.HorizontalList__Item.menu_item_dropdown .megamenuClose').on("click", function () { var target = $(this).closest('.MegaMenu').siblings('.toggle-button').removeClass('active').attr('aria-expanded', false); console.log(target); });

$('li.HorizontalList__Item.menu_item_dropdown .megamenuClose').on("click", function () {
    var target = $(this).closest('.MegaMenu').siblings('.toggle-button');
    console.log(target);
...
// Product__Wrapper
$('.Product__Info .Product__Tabs .Collapsible__Button').on("click", function () {
    var thisElement = $(this);
    
    setTimeout(function() {
        var newHeight = thisElement.closest('.Product__Info').outerHeight()
        // thisElement.closest('.Product__Wrapper').css('min-height', newHeight);
        thisElement.closest('.Product__Wrapper').animate({'min-height': newHeight}, 0);
      var headerHeight = $('#shopify-section-announcement').outerHeight() + $('#shopify-section-header').outerHeight();
      var headerHeightOffset = $('button.Collapsible__Button[aria-expanded="true"]').offset().top - headerHeight;
      $('html, body').animate({ scrollTop: headerHeightOffset }, 2000);
...
$(".Drawer").keydown(function(e) {
    var noteElement = document.querySelectorAll('.Cart__OffscreenNoteContainer[aria-hidden=false]');
    if(noteElement.length > 0 && 27 === e.keyCode){
        // console.log('this stop');
        $('.Drawer').removeClass('has-note-open');
        $('.Drawer .Cart__OffscreenNoteContainer[aria-hidden]').attr('aria-hidden',true);
        $('.Drawer .Cart__NoteButton').trigger('focus');
        // $(".Drawer").keydown(function(e) {
    } else if(e.keyCode === 27) {
        // console.log('this close');
        $('.Drawer[aria-modal="true"] .Drawer__Close').trigger('click');
    }
});
