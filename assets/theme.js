      ...
      value: function _updateProductPrices(newVariant, previousVariant) {
        ...
        if (!newVariant) {
          ...
          if (newVariant['compare_at_price'] > newVariant['price']) {
            ...
            productMetaPrices.innerHTML += '<s class="ProductMeta__Price Price Price--compareAt Text--subdued u-h4" data-money-convertible>' + __WEBPACK_IMPORTED_MODULE_4__helper_Currency__["default"].formatMoney(newVariant['compare_at_price'], window.theme.moneyFormat) + '</s>';
          } else {
          ...
          response.json().then(function (result) {
            ...
            if (response.ok) {
              ...
              Object.keys(result).forEach(function (key) {
                errorHtml += '<li class="Alert__ErrorItem" role="alert">' + key + ' ' + result[key] + '</li>';
              });
  ...
  var HeaderSection = function () {
    ...
    _createClass(HeaderSection, [{
      ...
      value: function _attachListeners() {
        ...
        this.delegateElement.on('mouseenter', '[aria-haspopup]', this._openMenu.bind(this), true);
...
/******/);
$('li.HorizontalList__Item.menu_item_dropdown .toggle-button').on( "click", function() {
  var menuVisible = $(this).attr('aria-expanded');
